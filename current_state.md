...
### 2026-04-17 - AI Feature Enhancement

- Enhanced knowledge-query Netlify Function to detect list-based queries (employees, tasks, projects)
- Added detectQueryIntent function to parse user queries for entity type requests
- Updated buildKnowledgeContext to fetch all entities when intent detected
- Added null checks for query parameter and all database fields to prevent runtime errors
- Committed: feat(ai): enable AI access to employee/task/project data on list queries
