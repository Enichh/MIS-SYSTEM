...
export function Sidebar() {
  ...
  return (
    <aside className="sidebar" role="navigation" aria-label="Main navigation">
      ...
      <div className="sidebar-footer" style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: "16px", paddingTop: "24px", borderTop: "1px solid var(--border-dark)" }}>
        {admin && (
          <div className="sidebar-admin-info" style={{ display: "flex", alignItems: "center", gap: "12px", color: "var(--color-text-secondary)" }}>
            <User size={18} />
            <span style={{ fontSize: "var(--text-sm)", fontWeight: 500 }}>{admin.full_name}</span>
          </div>
        )}
        <div className="sidebar-actions" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <button
